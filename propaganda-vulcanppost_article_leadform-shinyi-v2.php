        ...
        <div id="mc_embed_signup">
            <form id="propaganda-form" action="https://propaganda.cremedigital.com/forms/process.php?callback=?" method="post" target="_blank">      
                    ...
                    <div class="mc-field-group">
                        ...
                        <input type="number" value="" name="BANKNO" id="BANKNO" required>
                    </div>
                    <div class="mc-field-group">
                        <label for="PINNUMBER">Pin No. <span class="asterisk">*</span></label>
                        <input type="number" value="" name="PINNUMBER" id="PINNUMBER" required>
                    </div>
                    ...
                    <div class="clear">
                        <input type="submit" value="Do it now" name="Do it now" id="mc-embedded-subscribe" class="button">
                    </div>
                </div>
            </form>
